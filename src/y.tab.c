...
static const yytype_uint8 yyrline[] =
{
     ...
     163,   171,   175,   187,   191,   195,   200,   207,   213,   227
};
#endif
...
{
      22,   -10,   -10,   -10,   -10,    35,    22,     3,    29,   -10,
       1,    24,   -10,   -10,   -10,   -10,   -10,   -10,    33,   -10,
     -10,    -6,   -10,    29,    29,    38,    -1,   -10,    29,   -10,
      38,    12,    22,   -10
};
...
{
     -10,     0,    25,     2,    21,    -9,   -10,    -8,   -10
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,    16,    10,    17,    18,    24,     6,    11,     7
};
...
{
       4,    21,    29,    12,    25,     9,     4,     1,     2,     3,
       9,    19,    20,    19,    20,    32,    28,    13,     1,     2,
       3,    31,    14,    15,    33,     5,    27,    22,     1,     2,
       3,     0,     4,    27,    13,     1,     2,     3,     0,    14,
      15,     1,     2,     3,    26,    23,    20,     8,     0,    30,
      19,    20
};

static const yytype_int8 yycheck[] =
{
       0,    10,     3,     0,    10,     5,     6,     6,     7,     8,
      10,    12,    13,    12,    13,     3,    25,     5,     6,     7,
       8,    30,    10,    11,    32,     0,    24,     3,     6,     7,
       8,    -1,    32,    31,     5,     6,     7,     8,    -1,    10,
      11,     6,     7,     8,    23,    12,    13,    12,    -1,    28,
      12,    13
};
...
#line 213 "src/parser.y"
    ...
    strcpy(parsing_request->headers[parsing_request->header_count].header_name, (yyvsp[-7].str));
	strcpy(parsing_request->headers[parsing_request->header_count].header_value, (yyvsp[-3].str));
	parsing_request->header_count++;
}
#line 1514 "y.tab.c"
    break;
